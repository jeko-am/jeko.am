            ...
            <div className="flex flex-col md:flex-row min-h-[420px]">
              ...
              <div className="w-full md:w-[45%] relative min-h-[350px] md:min-h-[420px]">
                <Image
                  ...
                  className="object-cover"
                />
                {/* Vertical zigzag on left edge - teeth pointing RIGHT into image, color follows section bg */}
                <div
                  className="hidden md:block absolute left-0 top-0 h-full z-10 zigzag-vertical-left"
                  style={{ ['--zigzag-color' as string]: s[8]?.background_color || '#5F295E' } as React.CSSProperties}
                />
              </div>
            </div>
          </section>
