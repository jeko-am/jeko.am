                  ...
                  <div className="flex items-center gap-3">
                    {isAdmin ? (
                      <Link
                        ...
                        className={`bg-gold text-deep-green ${isHy ? "text-[13px] xl:text-[14px]" : "text-[14px] xl:text-[15px]"} font-rubik font-medium px-3 py-1.5 rounded-lg hover:bg-[#d99500] transition-all duration-200 flex items-center gap-1.5 whitespace-nowrap`}
                      >
            ...
            {user ? (
              <>
                {isAdmin ? (
                  <Link
                    href="/admin/dashboard"
                    className="bg-gold text-deep-green text-[18px] font-rubik font-semibold py-3 hover:bg-[#d99500] transition-all duration-200 flex items-center gap-3 px-4 rounded-lg"
                    onClick={() => setMobileMenuOpen(false)}
                  >
