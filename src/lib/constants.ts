export const COMMON_BREEDS = [
  ...
  "Boxer", "Cavalier King Charles Spaniel", "Miniature Schnauzer", "Shih Tzu",
  "Border Collie", "Cocker Spaniel", "Chihuahua", "Pug", "Staffordshire Bull Terrier",
  "Whippet", "Jack Russell Terrier", "Springer Spaniel", "Dalmatian", "Siberian Husky",
  "Doberman", "Great Dane", "Maltese", "Bernese Mountain Dog", "Corgi", "Bichon Frise",
  "Australian Shepherd", "Pomeranian", "Samoyed", "Weimaraner", "Vizsla",
  "Akita", "Shiba Inu", "Newfoundland", "Saint Bernard", "Irish Setter",
];
